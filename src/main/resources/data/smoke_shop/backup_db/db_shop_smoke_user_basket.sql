...
CREATE TABLE `user_basket` (
  ...
  KEY `fk_Users_has_Basket_Basket1_idx` (`basket_id`),
  KEY `fk_Users_has_Basket_Users1_idx` (`user_id`),
  CONSTRAINT `fk_Users_has_Basket_Basket1` FOREIGN KEY (`basket_id`) REFERENCES `basket` (`id_basket`),
  CONSTRAINT `fk_Users_has_Basket_Users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`)
...
-- Dump completed on 2019-01-28 15:58:07
