...
CREATE TABLE `user_role` (
  ...
  CONSTRAINT `fk_Users_has_Roles_Roles1` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id_role`),
  CONSTRAINT `fk_Users_has_Roles_Users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id_user`)
